...
class QuanAn2Object {
  ...
  QuanAn2Object(this.id, this.dia_danh_id, this.tenQuan, this.moTa, this.diaChi,
      this.sdt, this.thoiGianHoatDong, this.hinhAnh);
  QuanAn2Object.fromJson(Map<String, dynamic> quan)
      : id = quan["id"],
